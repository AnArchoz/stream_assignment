...
public class StreamAssignment {
	...
	public void task10() {
		...
		LocalDate date = people.stream().filter(person -> person.getPersonId() == 5914).
				findFirst().get().getDateOfBirth();
		s.add(date.getDayOfWeek()+" "+date.getDayOfMonth()+ " "+ date.getMonth() + " " +date.getYear());

		optional = s.stream().findFirst();
	...
	public void task11() {
		...
		//personToAge = people.stream().reduce();
